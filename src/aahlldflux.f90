...
! added for 9wave method -------------------------!
  b1  = 5.d-1 * ( (b1l +b1r ) - (phir-phil)/ch )  !
  phi = 5.d-1 * ( (phil+phir) - (b1r -b1l )*ch )  !
! end 9wave method--------------------------------!
...
! set frequently used variables --------!
  signsm  = sign(5.d-1,sm)             !
  sortsla = 5.d-1+sign(5.d-1, sla)     !
  sortsra = 5.d-1+sign(5.d-1,-sra)     !
  sortslr = 5.d-1-sign(5.d-1,sla*sra)  !
!---------------------------------------!
!print *,sortsla,sortsra,sortslr
  dla  =   (5.d-1+signsm) * dla  &
         + (5.d-1-signsm) * dra
  ...
  ela  =   sortsla * ela &
         + (5.d-1-sign(5.d-1, sla*sm)) * elaa &
         + (5.d-1+sign(5.d-1,-sm*sra)) * eraa &
         + (5.d-1-sign(5.d-1,sra)) * era
