...
!-----------------------------------------------------------------------------
 ...
 if(include_sinks) then
   ...
   if(frame>0) then
     call read_dummy_recordmarker(un)
     call read_var(un, frame_acc(1))
     call read_var(un, frame_acc(2))
     call read_var(un, frame_acc(3))
     call read_var(un, frame_vel(1))
     call read_var(un, frame_vel(2))
     call read_var(un, frame_vel(3))
     call read_var(un, frame_pos(1))
     call read_var(un, frame_pos(2))
     call read_var(un, frame_pos(3))
     call read_dummy_recordmarker(un)
   endif
 endif
